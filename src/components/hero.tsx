      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 flex flex-col items-center justify-center pointer-events-none -mt-10 md:-mt-16">
        ...
        >
          ...
          >
            ...
            <a href="/VISHNU__Resume%20.pdf.pdf" download className="group inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-transparent text-foreground border-2 border-accent/50 rounded-full font-bold hover:bg-accent/5 hover:border-accent hover:scale-105 transition-all duration-300 w-full sm:w-auto">
